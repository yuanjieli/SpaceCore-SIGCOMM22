...
constellation=sys.argv[1] #constellations=["starlink","kuiper","oneweb","iridium"]
cycle=100
single_upbound=int(sys.argv[2])#single_upbound=[2000,10000,20000,30000]
...
old_end_sp=np.array(np.load(path+gs_type+"_"+"old-end"+"_SP_delay_hop.npy",allow_pickle=True))  # access sat of ground station 
print(np.shape(old_end_sp))
old_new_sp=np.array(np.load(path+gs_type+"_"+"old-new"+"_SP_delay_hop.npy",allow_pickle=True))  # access sat of ground station 
print(np.shape(old_new_sp))
new_end_sp=np.array(np.load(path+gs_type+"_"+"new-end"+"_SP_delay_hop.npy",allow_pickle=True))  # access sat of ground station 
